 ...
 */
package com.wptdxii.framekit.util.optional;
...
import static com.wptdxii.framekit.util.Preconditions.checkNotNull;
...
public final class Predicates {
     ...
     * using Iterables#filter(Iterable, Class) in guava library.
     * in preference.
     * <p>
    ...
    private static class ContainsPatternPredicate implements Predicate<CharSequence>, Serializable {
        ...
        public boolean equals(@Nullable Object obj) {
            if (obj instanceof ContainsPatternPredicate) {
                ...
                return MoreObjects.equal(pattern.pattern(), that.pattern.pattern()) && MoreObjects.equal(pattern.flags(), that.pattern.flags());
            }
            return false;
        }
